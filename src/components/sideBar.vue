...
<template>
   ...
   <aside id="separator-sidebar"
      ...
      aria-label="Sidebar">
      <div class="h-full px-3 py-4 dark:border-t-[1px] dark:border-gray-700 overflow-y-auto bg-gray-50 dark:bg-gray-900">
         ...
         <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
            <li>
               <div
                  ...
                  <span class="ms-3">Số liệu thống kê</span>
               </div>
            </li>
            <li>
               <div
